...
export default {
  expo: {
    ...
    ios: {
        ...
        supportsTablet: true,
        infoPlist: {
            NSLocationWhenInUseUsageDescription: "This app uses location to find nearby job opportunities.",
            NSLocationAlwaysAndWhenInUseUsageDescription: "This app uses location to find nearby job opportunities.",
        },
    },
    android: {
        versionCode: 1,
